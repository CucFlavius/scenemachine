...
L["EDITOR_MSG_SAVE_MESSAGE"] = "La sauvegarde nécessite un rechargement de l'interface utilisateur, continuer ?";
L["EDITOR_SCENESCRIPT_WINDOW_TITLE"] = "Importer le script de scène";
...
L["EDITOR_TOOLBAR_TT_PIVOT_LOCAL_SPACE"] = "Pivot dans l'espace local";
L["EDITOR_TOOLBAR_TT_PIVOT_WORLD_SPACE"] = "Pivot dans l'espace mondial";
...
L["EDITOR_FULLSCREEN_NOTIFICATION"] = "Passage en plein écran\nAppuyez sur Échap pour quitter\nAppuyez sur P pour lire/mettre en pause";
L["EDITOR_TOOLBAR_TT_LETTERBOX_ON"] = "Cacher les barres noires";
L["EDITOR_TOOLBAR_TT_LETTERBOX_OFF"] = "Afficher les barres noires";
L["EDITOR_TOOLBAR_TT_FULLSCREEN"] = "Passer en plein écran";
...
L["AM_BUTTON_CHANGE_ANIMATION"] = "Changer anim";
...
L["AM_TOOLBAR_TT_UIMODE"] = "Changer de mode d'animation";
L["AM_TOOLBAR_TTD_UIMODE"] = "Changer de mode d'animation:\n" ..
L["AM_TOOLBAR_TT_ADD_TRACK"] = "Ajouter piste";
L["AM_TOOLBAR_TTD_ADD_TRACK"] = "Ajouter piste:\n" ..
L["AM_TOOLBAR_TT_REMOVE_TRACK"] = "Supprimer piste";
L["AM_TOOLBAR_TT_ADD_ANIMATION"] = "Ajouter animation";
L["AM_TOOLBAR_TTD_ADD_ANIMATION"] = "Ajouter animation:\n" ..
L["AM_TOOLBAR_TT_REMOVE_ANIMATION"] = "Supprimer animation";
L["AM_TOOLBAR_TT_ADD_KEYFRAME"] = "Ajouter image-clé";
L["AM_TOOLBAR_TTD_ADD_KEYFRAME"] = "Ajouter image-clé:\n" ..
L["AM_TOOLBAR_TT_SET_INTERPOLATION_IN"] = "Définir interpolation entrante";
L["AM_TOOLBAR_TTD_SET_INTERPOLATION_IN"] = "Définir interpolation entrante:\n" ..
L["AM_TOOLBAR_TT_SET_INTERPOLATION_OUT"] = "Définir interpolation sortante";
L["AM_TOOLBAR_TTD_SET_INTERPOLATION_OUT"] = "Définir interpolation sortante:\n" ..
L["AM_TOOLBAR_TT_REMOVE_KEYFRAME"] = "Supprimer image-clé";
L["AM_TOOLBAR_TT_SEEK_TO_START"] = "Aller au début";
L["AM_TOOLBAR_TT_SKIP_FRAME_BACK"] = "Passer à l'image précédente";
L["AM_TOOLBAR_TT_PLAY_PAUSE"] = "Lire / Mettre en pause";
L["AM_TOOLBAR_TT_SKIP_FRAME_FORWARD"] = "Passer à l'image suivante";
L["AM_TOOLBAR_TT_SEEK_TO_END"] = "Aller à la fin";
L["AM_TOOLBAR_TT_LOOP"] = "Lire en boucle activé/désactivé";
...
L["AM_RMB_CHANGE_ANIM"] = "Changer l'animation";
...
L["AB_TOOLBAR_TT_ADD_OBJECT"] = "Ajouter un objet sélectionné";
...
-- Project Manager --
L["PM_WINDOW_TITLE"] = "Gestionnaire de projet";
...
L["PM_MSG_DELETE_PROJECT_MESSAGE"] = "La suppression du projet entraînera également la suppression de toutes ses scènes et données, continuer ?";
L["PM_BUTTON_NEW_PROJECT"] = "Nouveau projet";
L["PM_BUTTON_LOAD_PROJECT"] = "Charger projet";
...
L["OP_BACKGROUND_COLOR"] = "Couleur d'arrière-plan";
...
L["NEARCLIP"] = "Plan rapproché";
L["FARCLIP"] = "Plan lointain";

-- Scene Hierarchy --
L["SH_TITLE"] = "Hiérarchie de la scène";

-- Color Picker --
L["COLP_WINDOW_TITLE"] = "Sélecteur de couleur";
L["COLP_RGB_NAME"] = "RVB (Rouge/Vert/Bleu) :";
L["COLP_HSL_NAME"] = "TSL (Teinte/Saturation/Luminosité) :";
L["COLP_R"] = "R";  -- Rouge
L["COLP_G"] = "V";  -- Vert
L["COLP_B"] = "B";  -- Bleu
L["COLP_H"] = "H";  -- Teinte
...
-- About Screen --
L['ABOUT_WINDOW_TITLE'] = "Machine à scènes";
L['ABOUT_VERSION'] = "Version %s";
L['ABOUT_DESCRIPTION'] = "La Machine à scènes est un outil permettant de créer et d'éditer des scènes 3D en utilisant les modèles disponibles en jeu. Elle utilise l'API ModelScene comme base, donc certaines limitations s'appliquent.";
...
L["SETTINGS_HIDE_PARALLEL_GIZMOS"] = "Masquer les gizmos de translation parallèles à la caméra";
L["SETTINGS_ALWAYS_SHOW_CAM_GIZMO"] = "Toujours afficher le gizmo de caméra";
L["SETTINGS_GIZMO_SIZE"] = "Taille du gizmo";
L["SETTINGS_SHOW_DEBUG_TAB"] = "Afficher l'onglet de débogage dans le navigateur d'assets";

-- Error Messages --
L["DECODE_FAILED"] = "Impossible de décoder les données.";
L["DECOMPRESS_FAILED"] = "Échec de la décompression des données.";
L["DESERIALIZE_FAILED"] = "Échec de la désérialisation des données.";
L["DATA_VERSION_TOO_NEW"] = "Version de données plus récente détectée, et non prise en charge. Veuillez mettre à jour SceneMachine.";
