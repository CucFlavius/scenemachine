...
L["SCROLL_BOTTOM"] = "Ir para o fundo";
L["LOAD"] = "Carregar";
...
L["EDITOR_MSG_DELETE_OBJECT_MESSAGE"] = "O objeto contém uma trilha de animação, tem certeza de que deseja excluir?";
L["EDITOR_MSG_DELETE_TRACK_TITLE"] = "Excluir Trilha";
L["EDITOR_MSG_DELETE_TRACK_A_K_MESSAGE"] = "A trilha contém animações e keyframes, tem certeza de que deseja excluir?";
L["EDITOR_MSG_DELETE_TRACK_A_MESSAGE"] = "A trilha contém animações, tem certeza de que deseja excluir?";
L["EDITOR_MSG_DELETE_TRACK_K_MESSAGE"] = "A trilha contém keyframes, tem certeza de que deseja excluir?";
L["EDITOR_MSG_SAVE_TITLE"] = "Salvar";
L["EDITOR_MSG_SAVE_MESSAGE"] = "Salvar requer uma recarga da interface do usuário, continuar?";
...
L["EDITOR_TOOLBAR_TT_SCALE_TOOL"] = "Ferramenta de Escalonar";
...
L["EDITOR_TOOLBAR_TT_LETTERBOX_ON"] = "Ocultar Faixas Pretas";
L["EDITOR_TOOLBAR_TT_LETTERBOX_OFF"] = "Mostrar Faixas Pretas";
...
L["MM_KEYBOARD_SHORTCUTS"] = "Atalhos do Teclado";
L["MM_ABOUT"] = "Sobre";
L["MM_SCENE"] = "Cena";
L["MM_SCENE_NEW"] = "Nova";
...
L["AM_TIMELINE"] = "Linha do Tempo %d";           -- número da linha do tempo
L["AM_MSG_DELETE_TIMELINE_TITLE"] = "Excluir Linha do Tempo";
L["AM_MSG_DELETE_TIMELINE_MESSAGE"] = "Tem certeza de que deseja continuar?";
L["AM_MSG_NO_TRACK_TITLE"] = "Sem Pista";
L["AM_MSG_NO_TRACK_MESSAGE"] = "O objeto não possui uma pista de animação, deseja adicionar uma?";
L["AM_BUTTON_ADD_ANIMATION"] = "Adicionar Anim";
L["AM_BUTTON_CHANGE_ANIMATION"] = "Alterar Anim";
L["AM_TIMELINE_NAME"] = "Nome da Linha do Tempo";
L["AM_TOOLBAR_TRACKS"] = "Pistas";
L["AM_TOOLBAR_KEYFRAMES"] = "Keyframes";
L["AM_TOOLBAR_CURVES"] = "Curvas (apenas debug)";
L["AM_TOOLBAR_TT_UIMODE"] = "Alterar Modo de Animação";
L["AM_TOOLBAR_TTD_UIMODE"] = "Alterar Modo de Animação:\n" ..
L["AM_TOOLBAR_TT_ADD_TRACK"] = "Adicionar Pista";
L["AM_TOOLBAR_TTD_ADD_TRACK"] = "Adicionar Pista:\n" ..
L["AM_TOOLBAR_TT_REMOVE_TRACK"] = "Excluir Pista";
...
L["AM_TOOLBAR_TT_SET_INTERPOLATION_IN"] = "Configurar Interpolação de Entrada";
L["AM_TOOLBAR_TTD_SET_INTERPOLATION_IN"] = "Configurar Interpolação de Entrada:\n" ..
L["AM_TOOLBAR_TT_SET_INTERPOLATION_OUT"] = "Configurar Interpolação de Saída";
L["AM_TOOLBAR_TTD_SET_INTERPOLATION_OUT"] = "Configurar Interpolação de Saída:\n" ..
L["AM_TOOLBAR_TT_REMOVE_KEYFRAME"] = "Excluir Keyframe";
L["AM_TOOLBAR_TT_SEEK_TO_START"] = "Ir para o Início";
L["AM_TOOLBAR_TT_SKIP_FRAME_BACK"] = "Pular para o frame anterior";
L["AM_TOOLBAR_TT_PLAY_PAUSE"] = "Reproduzir / Pausar";
L["AM_TOOLBAR_TT_SKIP_FRAME_FORWARD"] = "Pular para o próximo frame";
L["AM_TOOLBAR_TT_SEEK_TO_END"] = "Ir para o Fim";
L["AM_TOOLBAR_TT_LOOP"] = "Reprodução em Loop ligado/desligado";
L["AM_TOOLBAR_TT_PLAYCAMERA"] = "Reprodução de Câmera ligada/desligada";
L["AM_TT_LIST"] = "Selecionar Linha do Tempo";
L["AM_TT_ADDTIMELINE"] = "Adicionar Linha do Tempo";
...
L["AM_TIMER_SET_DURATION"] = "Definir Duração da Linha do Tempo";

-- AssetBrowser/AssetExplorer --
L["AB_RESULTS"] = "%d Resultados"; -- <number> resultados (resultados da pesquisa)
...
L["PM_MSG_DELETE_PROJECT_MESSAGE"] = "Excluir o projeto também excluirá todas as suas cenas e dados, continuar?";
...
L["NEARCLIP"] = "Corte Próximo";
L["FARCLIP"] = "Corte Distante";

-- Scene Hierarchy --
L["SH_TITLE"] = "Hierarquia de Cena";
...
L["COLP_R"] = "V";  -- Vermelho (Red)
L["COLP_G"] = "Vd";  -- Verde (Green)
L["COLP_B"] = "Az";  -- Azul (Blue)
L["COLP_H"] = "M";  -- Matiz (Hue)
L["COLP_S"] = "S";  -- Saturação (Saturation)
L["COLP_L"] = "L";  -- Luminosidade (Lightness)

-- About Screen --
L["ABOUT_WINDOW_TITLE"] = "Máquina de Cenários";
L["ABOUT_VERSION"] = "Versão %s";
L["ABOUT_DESCRIPTION"] = "A Máquina de Cenários é uma ferramenta para criar e editar cenas 3D usando modelos disponíveis no jogo. Ela utiliza a API ModelScene como base, então algumas limitações se aplicam.";
...
L["SETTINGS_HIDE_PARALLEL_GIZMOS"] = "Ocultar gizmos de translação paralelos à câmera";
...
L["DATA_VERSION_TOO_NEW"] = "Detectada uma versão mais recente dos dados, não suportada. Por favor, atualize o SceneMachine.";
