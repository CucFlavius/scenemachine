...
local L = AceLocale:NewLocale("SceneMachine", "enUS", true, true);
...
L["AB_TAB_MODELS"] = "Models";
L["AB_TAB_CREATURES"] = "Creatures";
...
L["SETTINGS_EDITOR_SCALE"] = "Editor Scale";
L["SETTINGS_SHOW_SELECTION_HIGHLIGHT"] = "Show selection highlight";
L["SETTINGS_HIDE_PARALLEL_GIZMOS"] = "Hide translation gizmos parallel to the camera";
L["SETTINGS_ALWAYS_SHOW_CAM_GIZMO"] = "Always show camera gizmo";
L["SETTINGS_GIZMO_SIZE"] = "Gizmo size";
L["SETTINGS_SHOW_DEBUG_TAB"] = "Show Debug tab in Asset Browser";
