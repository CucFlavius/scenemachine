...
L["IMPORT"] = "导入";
L["SCROLL_TOP"] = "跳到顶部";
L["SCROLL_BOTTOM"] = "跳到底部";
L["LOAD"] = "加载";

-- Editor --
L["ADDON_NAME"] = "场景机器";
L["EDITOR_MAIN_WINDOW_TITLE"] = "场景机器 %s - %s";       -- 场景机器 <版本> - <当前项目名称>
L["EDITOR_MSG_DELETE_OBJECT_TITLE"] = "删除对象";
L["EDITOR_MSG_DELETE_OBJECT_MESSAGE"] = "该对象包含一个动画轨道，确认删除吗？";
L["EDITOR_MSG_DELETE_TRACK_TITLE"] = "删除轨道";
L["EDITOR_MSG_DELETE_TRACK_A_K_MESSAGE"] = "该轨道包含动画和关键帧，确认删除吗？";
L["EDITOR_MSG_DELETE_TRACK_A_MESSAGE"] = "该轨道包含动画，确认删除吗？";
L["EDITOR_MSG_DELETE_TRACK_K_MESSAGE"] = "该轨道包含关键帧，确认删除吗？";
L["EDITOR_MSG_SAVE_TITLE"] = "保存";
L["EDITOR_MSG_SAVE_MESSAGE"] = "保存需要重新加载UI，继续吗？";
L["EDITOR_SCENESCRIPT_WINDOW_TITLE"] = "导入场景脚本";
L["EDITOR_TOOLBAR_TT_OPEN_PROJECT_MANAGER"] = "打开项目管理器";
L["EDITOR_TOOLBAR_TT_PROJECT_LIST"] = "更改项目";
...
L["EDITOR_TOOLBAR_TT_PIVOT_LOCAL_SPACE"] = "本地坐标轴中心点";
L["EDITOR_TOOLBAR_TT_PIVOT_WORLD_SPACE"] = "世界坐标轴中心点";
L["EDITOR_TOOLBAR_TT_PIVOT_CENTER"] = "中心点中心点";
L["EDITOR_TOOLBAR_TT_PIVOT_BASE"] = "基准点中心点";
L["EDITOR_IMPORT_EXPORT_WINDOW_TITLE"] = "导入 - 导出";
L["EDITOR_NAME_RENAME_WINDOW_TITLE"] = "名称 - 重命名";
L["EDITOR_TOOLBAR_TT_MULTITRANSFORM_TOGETHER"] = "联合变换";
L["EDITOR_TOOLBAR_TT_MULTITRANSFORM_INDIVIDUAL"] = "单独变换";
L["EDITOR_TOOLBAR_TT_UNDO"] = "撤销";
L["EDITOR_TOOLBAR_TT_REDO"] = "重做";
L["EDITOR_TOOLBAR_TT_CREATE_CAMERA"] = "创建相机";
L["EDITOR_TOOLBAR_TT_CREATE_CHARACTER"] = "创建角色";
L["EDITOR_FULLSCREEN_NOTIFICATION"] = "进入全屏\n按ESC键退出\n按P键播放/暂停";
L["EDITOR_TOOLBAR_TT_LETTERBOX_ON"] = "隐藏信箱（黑边）";
L["EDITOR_TOOLBAR_TT_LETTERBOX_OFF"] = "显示信箱（黑边）";
L["EDITOR_TOOLBAR_TT_FULLSCREEN"] = "进入全屏";
...
L["MM_SAVE"] = "保存";
L["MM_CLONE_SELECTED"] = "克隆选定项";
L["MM_DELETE_SELECTED"] = "删除选定项";
...
L["AM_MSG_DELETE_TIMELINE_MESSAGE"] = "确定要继续吗？";
...
L["AM_TOOLBAR_TT_SET_INTERPOLATION_IN"] = "设置缓入";
L["AM_TOOLBAR_TTD_SET_INTERPOLATION_IN"] = "设置缓入:\n";
L["AM_TOOLBAR_TT_SET_INTERPOLATION_OUT"] = "设置缓出";
L["AM_TOOLBAR_TTD_SET_INTERPOLATION_OUT"] = "设置缓出:\n";
L["AM_TOOLBAR_TT_REMOVE_KEYFRAME"] = "删除关键帧";
L["AM_TOOLBAR_TT_SEEK_TO_START"] = "跳至开始";
L["AM_TOOLBAR_TT_SKIP_FRAME_BACK"] = "跳到上一帧";
L["AM_TOOLBAR_TT_PLAY_PAUSE"] = "播放 / 暂停";
L["AM_TOOLBAR_TT_SKIP_FRAME_FORWARD"] = "跳到下一帧";
L["AM_TOOLBAR_TT_SEEK_TO_END"] = "跳至结束";
L["AM_TOOLBAR_TT_LOOP"] = "循环播放 开/关";
L["AM_TOOLBAR_TT_PLAYCAMERA"] = "摄像机播放 开/关";
L["AM_TT_LIST"] = "选择时间轴";
L["AM_TT_ADDTIMELINE"] = "添加时间轴";
L["AM_RMB_CHANGE_ANIM"] = "更改动画";
L["AM_RMB_SET_ANIM_SPEED"] = "设置动画速度";
L["AM_RMB_DELETE_ANIM"] = "删除动画";
L["AM_RMB_DIFFERENT_COLOR"] = "不同的颜色";
L["AM_SET_ANIMATION_SPEED_PERCENT"] = "设置动画速度 %";
L["AM_TIMER_SET_DURATION"] = "设置时间轴持续时间";

-- AssetBrowser/AssetExplorer --
L["AB_RESULTS"] = "%d 结果";             -- <number> results (search results)
L["AB_BREADCRUMB"] = "路径为...";             -- for a file path
L["AB_TOOLBAR_TT_UP_ONE_FOLDER"] = "返回上级文件夹";
L["AM_MSG_REMOVE_COLLECTION_TITLE"] = "移除收藏夹";
L["AB_MSG_REMOVE_COLLECTION_MESSAGE"] = "该收藏夹包含物品，确定要移除吗？";
...
-- About Screen --
L["ABOUT_WINDOW_TITLE"] = "场景编辑器";
L["ABOUT_VERSION"] = "版本 %s";
L["ABOUT_DESCRIPTION"] = "场景编辑器是一个使用游戏内可用模型创建和编辑3D场景的工具。它基于ModelScene API开发，因此有一些限制。";
L["ABOUT_LICENSE"] = "根据 MIT 许可证授权";
L["ABOUT_AUTHOR"] = "作者：%s";
L["ABOUT_CONTACT"] = "联系方式：%s";
...
L["SETTINGS_EDITOR_SCALE"] = "编辑器缩放";
L["SETTINGS_SHOW_SELECTION_HIGHLIGHT"] = "显示选择高亮";
L["SETTINGS_HIDE_PARALLEL_GIZMOS"] = "隐藏平行于摄像机的平移小工具";
L["SETTINGS_ALWAYS_SHOW_CAM_GIZMO"] = "始终显示摄像头小工具";
L["SETTINGS_GIZMO_SIZE"] = "小工具尺寸";
L["SETTINGS_SHOW_DEBUG_TAB"] = "在资源浏览器中显示调试选项卡";

-- Error Messages --
L["DECODE_FAILED"] = "数据解码失败。";
L["DECOMPRESS_FAILED"] = "数据解压失败。";
L["DESERIALIZE_FAILED"] = "数据反序列化失败。";
L["DATA_VERSION_TOO_NEW"] = "检测到较新的数据版本，不受支持。请更新 SceneMachine。";
