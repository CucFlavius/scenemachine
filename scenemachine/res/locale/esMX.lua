...
L["EDITOR_MSG_SAVE_MESSAGE"] = "Guardar requiere recargar la interfaz, ¿continuar?";
L["EDITOR_SCENESCRIPT_WINDOW_TITLE"] = "Importar Guión de Escena";
...
L["MM_HELP"] = "Ayuda";
L["MM_PROJECT_MANAGER"] = "Administrador de Proyectos";
L["MM_IMPORT_SCENESCRIPT"] = "Importar Scripts de Escenas";
L["MM_SAVE"] = "Guardar";
...
L["AM_TIMELINE_NAME"] = "Nombre de cronología";
L["AM_TOOLBAR_TRACKS"] = "Pistas";
L["AM_TOOLBAR_KEYFRAMES"] = "Fotogramas clave";
L["AM_TOOLBAR_CURVES"] = "Curvas (solo debug)";
...
L["AM_TOOLBAR_TT_PLAY_PAUSE"] = "Reproducir / Pausa";
...
L["AM_TT_ADDTIMELINE"] = "Añadir cronología";
...
L["AM_TIMER_SET_DURATION"] = "Establecer duración de cronología";

-- AssetBrowser/AssetExplorer --
L["AB_RESULTS"] = "%d Resultados"; -- <number> resultados
L["AB_BREADCRUMB"] = "..."; -- para una ruta de archivo
L["AB_TOOLBAR_TT_UP_ONE_FOLDER"] = "Subir un nivel.";
...
L["NEARCLIP"] = "Clip Cercano";
L["FARCLIP"] = "Clip Lejano";
...
L["ABOUT_DESCRIPTION"] = "Máquina de Escenas es una herramienta para crear y editar escenas en 3D utilizando modelos disponibles en el juego. Se basa en la API de ModelScene, por lo que aplican algunas limitaciones.";
...
L["SETTINGS_TAB_GIZMOS"] = "Herramientas";
...
L["SETTINGS_HIDE_PARALLEL_GIZMOS"] = "Ocultar gizmos de traslación paralelos a la cámara";
L["SETTINGS_ALWAYS_SHOW_CAM_GIZMO"] = "Mostrar siempre el gizmo de la cámara";
...
L["DATA_VERSION_TOO_NEW"] = "Se ha detectado una versión más nueva de los datos, que no es compatible. Por favor, actualiza SceneMachine.";
